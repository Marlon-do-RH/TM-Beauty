...
function InstagramIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-label="Instagram">
...
function WhatsAppIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-label="WhatsApp">
...
function EmailIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-label="Email">
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.col}>
          ...
          <div className={styles.socialIcons}>
            ...
            <Link to="/contato" className={styles.socialIcon} aria-label="Email">
              <EmailIcon />
            </Link>
          </div>
        </div>
